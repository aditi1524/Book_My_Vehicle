...
try{
	...
	c = DriverManager.getConnection("jdbc:mysql://localhost:3306/vdb","root","aditi");
...
body {
	...
	background-image: linear-gradient(rgba(0, 0, 0, 0.35),
		rgba(0, 0, 0, 0.35)), url(images/back.jpg);
	background-size: 100%;
		...
		<table width="1200px" border="0" align="center"
			...
			<tr>
				<th colspan="3" bgcolor="#D22929" scope="col"><div
						align="center">
						<span class="style3"><span class="style4"><marquee
									style="font-size:2em">Vehicle Management System</marquee></span></span>
					</div></th>
			</tr>
			<tr>
				<td>&nbsp;</td>
		  ...
		  if(op.equals("NO")){
		  	%>
									<h3 color="#000000">Login Failed. Re-Login Again</h3> <%
		  }
		  %>
								</th>
							</tr>
							...
							<tr>
								<td colspan="2"><div align="center">
										<span class="style1" style="font-size: 27px">Admin
											Login Panel </span>
									</div></td>
							</tr>
							<tr>
							...
							<tr>
								<td width="22%"><span ><strong class="style6">User
											Name :</strong></span> <span class="style5"> <label></label>
								</span></td>
								<td width="32%"><label> <input name="Username"
										type="text" id="Username" />
								</label></td>
							</tr>
							<tr>
								<td><span >&nbsp;<strong class="style6">Password
											:</strong> <label> </label>
